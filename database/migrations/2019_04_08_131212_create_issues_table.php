...
class CreateIssuesTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('issues', function (Blueprint $table) {
            ...
            $table->string('parent_key', 10)->nullable();
            ...
            $table->string('priority_name', 20)->nullable()->index();
            $table->string('priority_icon_url', 255)->nullable();
            $table->string('reporter_key', 35)->nullable();
            $table->string('reporter_name', 35)->nullable();
            $table->string('reporter_icon_url', 255)->nullable();
            $table->string('assignee_key', 35)->nullable()->index();
            $table->string('assignee_name', 35)->nullable();
            ...
            $table->string('rank', 50)->nullable()->index();
