<h3 class="sidebar-item text-base">
    <router-link exact to="/" class="text-white text-justify no-underline p-4 w-full flex items-center">
        ...
        <span class="sidebar-label" style="margin-top: 2px">{{ __('Dashboard') }}</span>
    </router-link>
</h3>