...
Nova.booting(function (Vue, router, store) {
    Vue.component('index-color-swatch', __webpack_require__(3));
    Vue.component('detail-color-swatch', __webpack_require__(6));
    Vue.component('form-color-swatch', __webpack_require__(9));
    Vue.component('color-swatch', __webpack_require__(18));
});
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    computed: {
        primary: function primary() {
            return JSON.parse(this.field.value).primary;
        },
        secondary: function secondary() {
            return JSON.parse(this.field.value).secondary;
        },
        pattern: function pattern() {
            return JSON.parse(this.field.value).pattern;
        }
    }
        ...
        _c(
          ...
          [
            ...
            _c("input", {
              ...
              ref: "primary",
              staticClass: "form-control w-9 mr-2",
              attrs: { type: "color" },
              domProps: { value: _vm.primary },
              on: {
                change: _vm.update,
            ...
            _c("input", {
              ...
              ref: "secondary",
              staticClass: "form-control w-9",
              attrs: { type: "color" },
              domProps: { value: _vm.secondary },
              on: {
                change: _vm.update,
                input: function($event) {
                  if ($event.target.composing) {
                  ...
                  _vm.secondary = $event.target.value
                }
              }
            })
          ],
...
Component.options.__file = "resources/js/components/Swatch.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-26c34467", Component.options)
  } else {
    hotAPI.reload("data-v-26c34467", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
/* harmony default export */ __webpack_exports__["default"] = ({
    props: ['primary', 'secondary', 'pattern'],

    methods: {
        refresh: function refresh() {
            var _this = this;

            _.each(this.swatchStyle, function (v, k) {
                return _this.$el.style[k] = v;
            });
        }
    },
    ...
    computed: {
        ...
        backgroundStyle: function backgroundStyle() {
            ...
            return {
                'background': ('linear-gradient(\n                    135deg,\n                    ' + this.primary + ' 33.33%,\n                    ' + this.secondary + ' 33.33%,\n                    ' + this.secondary + ' 50%,\n                    ' + this.primary + ' 50%,\n                    ' + this.primary + ' 83.33%,\n                    ' + this.secondary + ' 83.33%,\n                    ' + this.secondary + ' 100%\n                )').replace(/\r?\n\s*/g, ''),
                'background-size': '4.24px 4.24px'
            };
        },
        swatchStyle: function swatchStyle() {
            return Object.assign(this.baseStyle, this.backgroundStyle);
        }
    }
...
var render = function() {
  ...
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("div", { style: _vm.swatchStyle })
}
var staticRenderFns = []
render._withStripped = true
module.exports = { render: render, staticRenderFns: staticRenderFns }
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-26c34467", module.exports)
  }
}
