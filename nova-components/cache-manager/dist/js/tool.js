...
window.refreshNovaData = function () {
    ...
    var components = getDescendants(Nova.app);
    var elements = Nova.app.$children;
};
...
window.getDescendants = function (component) {
    ...
    var children = descendants = component.$children;
...
var render = function() {
  ...
  return _c(
    "div",
    [
      _c("heading", { staticClass: "mb-6" }, [_vm._v("Cache Manager")]),
      _vm._v(" "),
      _c(
        "card",
        {
        ...
        [
          ...
          _c("p", { staticClass: "text-white-50% text-lg" }, [
            ...
            _c(
              ...
              [
                _vm._v(
                  "/nova-components/CacheManager/resources/js/components/Tool.vue"
                )
              ]
            )
          ])
