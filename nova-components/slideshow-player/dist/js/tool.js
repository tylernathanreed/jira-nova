...
/* scopeId */
var __vue_scopeId__ = "data-v-fa9dbcd8"
...
Component.options.__file = "resources/js/components/SlideshowPlayer.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-fa9dbcd8", Component.options)
  } else {
    hotAPI.reload("data-v-fa9dbcd8", Component.options)
  }
...
Nova.booting(function (Vue, router, store) {
    Vue.component('slideshow-player', __webpack_require__(0));
});
...
var update = __webpack_require__(6)("0f1d05ba", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../node_modules/css-loader/index.js!../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-fa9dbcd8\",\"scoped\":true,\"hasInlineConfig\":true}!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./SlideshowPlayer.vue", function() {
     var newContent = require("!!../../../node_modules/css-loader/index.js!../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-fa9dbcd8\",\"scoped\":true,\"hasInlineConfig\":true}!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./SlideshowPlayer.vue");
...
// module
exports.push([module.i, "\n.slideshow-page[data-v-fa9dbcd8] {\n    -webkit-transition: opacity 1.5s;\n    transition: opacity 1.5s;\n}\n.page-timer[data-v-fa9dbcd8] {\n    position: absolute;\n    left: 0px;\n    right: 0px;\n    bottom: 0px;\n    height: 2px;\n    width: 0%;\n    -webkit-transition: width 1s;\n    transition: width 1s;\n    z-index: 999999;\n}\n", ""]);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_laravel_nova__ = __webpack_require__(13);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
                ...
                return __WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.wrap(function _callee$(_context) {
                    while (1) {
                        switch (_context.prev = _context.next) {
                            ...
                            case 4:
                                _context.next = 6;
                                return this.getSlideshowPages();

                            case 6:
                                _context.next = 8;
                                return this.startPageTimer();
        ...
        setTheme: function setTheme() {
            ...
            var theme = _.find(this.resource.fields, { attribute: 'theme' }).value;
         ...
         * @return {Array}
         */
        getSlideshowPages: function getSlideshowPages() {
            var _this2 = this;

            return Object(__WEBPACK_IMPORTED_MODULE_1_laravel_nova__["Minimum"])(Nova.request().get('/nova-api/slideshow-pages', {
                params: this.slideshowPagesRequestQueryString
            }), 300).then(function (_ref3) {
                var data = _ref3.data;

                _this2.pages = data.resources;
                _this2.pageIndex = 0;
            });
        },
        startPageTimer: function startPageTimer() {
            var _this3 = this;
            ...
            this._pageTimer = setInterval(function () {
                _this3.tickPageTimer();
            }, this._pageTickInterval);

            setTimeout(function () {
                setTimeout(function () {
                    _this3.startScrollTimer();
                }, _this3.getScrollInterval() - 5000);
            }, 5000);
        },
        tickPageTimer: function tickPageTimer() {
        ...
        increasePageTimer: function increasePageTimer(num) {
            this.pagePercent += num;
        },
        finishPageTimer: function finishPageTimer() {
            var _this4 = this;
            ...
            setTimeout(function () {
                _this4.pageIndex = (_this4.pageIndex + 1) % _this4.pages.length;
            }, 500);

            setTimeout(function () {
                _this4.pageOpacity = 1;
            }, 3500);

            setTimeout(function () {
                _this4.startPageTimer();
            }, 5000);
        },
        pausePageTimer: function pausePageTimer() {
            clearInterval(this._pageTimer);
        },
        startScrollTimer: function startScrollTimer() {
            ...
            this._scrollTimer = setInterval(function () {
                _this5.tickScrollTimer();
            }, this._scrollTickInterval);
        },
        tickScrollTimer: function tickScrollTimer() {
        ...
        increaseScrollTimer: function increaseScrollTimer(num) {

            this.scrollTo += num * this.scrollDirection;
            this.$refs.page.contentWindow.scrollTo(0, this.scrollTo);
        },
        finishScrollTimer: function finishScrollTimer() {
            var _this6 = this;
            ...
            setTimeout(function () {
                _this6.startScrollTimer();
            }, this.getScrollInterval());
        },
        pauseScrollTimer: function pauseScrollTimer() {
            clearInterval(this._scrollTimer);
        },
...
var render = function() {
  ...
  return _c("loading-view", { attrs: { loading: _vm.initialLoading } }, [
    _c("div", { staticClass: "overflow-hidden" }, [
      _c("iframe", {
        ref: "page",
        staticClass: "slideshow-page w-screen h-screen -mb-1",
        style: { opacity: _vm.pageOpacity },
    ...
    _vm.showTimer
      ? _c("div", {
          staticClass: "page-timer bg-primary",
          style: {
            width: _vm.pagePercent + "%",
            height: "3px"
          }
        })
      : _vm._e()
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-fa9dbcd8", module.exports)
  }
}
